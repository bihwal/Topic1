        ...
        btnEq.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              //  textOne=calc.getFirst();
                ...
                calc.setSecond(textTwo);

                if (symbol == 1) {
                    textcheckSum.setText(calc.Foradd());
                    txtDis.setText(Integer.toString(calc.add()));
                  //  calc.add();
                } else if (symbol == 2) {
                    textcheckSum.setText(calc.Forsub());
                    txtDis.setText(Integer.toString(calc.sub()));
                   // calc.sub();
                } else if (symbol == 3) {
                    textcheckSum.setText(calc.Formul());
                    txtDis.setText(Integer.toString(calc.Mul()));
                    //calc.Mul();
                } else if (symbol == 4) {
                    textcheckSum.setText(calc.Fordiv());
                    txtDis.setText(Integer.toString(calc.Div()));
                   // calc.Div();
                }
